...
activation_plot_xvals = np.arange(0, 300, dt)
fig.suptitle("Unit Activations and Stimulus")
axs[0].plot(activation_plot_xvals, v_hist_test[2,0:-1]) 
axs[0].set_ylabel("OUT Unit Activation")
axs[0].set_ylim([0,1])
axs[0].grid('on')
axs[1].plot(activation_plot_xvals, v_hist_test[1,0:-1])
axs[1].set_ylabel("MID Unit Activation")
axs[1].set_ylim([0,1])
axs[1].grid('on')
axs[2].plot(activation_plot_xvals, v_hist_test[0,0:-1])
axs[2].set_ylabel("IN Unit Activation")
axs[2].set_ylim([0,1])
axs[2].grid('on')
axs[3].plot(activation_plot_xvals, data1[0])
